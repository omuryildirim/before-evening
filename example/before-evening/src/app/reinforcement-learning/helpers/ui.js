...
let appStatus = document.getElementById('app-status');
let storedModelStatusInput = document.getElementById('stored-model-status');
let hiddenLayerSizesInput = document.getElementById('hidden-layer-sizes');
let createModelButton = document.getElementById('create-model');
let deleteStoredModelButton = document.getElementById('delete-stored-model');

let numIterationsInput = document.getElementById('num-iterations');
let gamesPerIterationInput = document.getElementById('games-per-iteration');
let discountRateInput = document.getElementById('discount-rate');
let maxStepsPerGameInput = document.getElementById('max-steps-per-game');
let renderDuringTrainingCheckbox = document.getElementById('render-during-training');

let trainButton = document.getElementById('train');
let testButton = document.getElementById('test');
let iterationStatus = document.getElementById('iteration-status');
let iterationProgress = document.getElementById('iteration-progress');
let trainStatus = document.getElementById('train-status');
let bestPosition = document.getElementById('best-position');
...
const initializeUIElements = () => {
  ...
  storedModelStatusInput = document.getElementById('stored-model-status');
  hiddenLayerSizesInput = document.getElementById('hidden-layer-sizes');
  createModelButton = document.getElementById('create-model');
  deleteStoredModelButton = document.getElementById('delete-stored-model');

  numIterationsInput = document.getElementById('num-iterations');
  gamesPerIterationInput = document.getElementById('games-per-iteration');
  discountRateInput = document.getElementById('discount-rate');
  maxStepsPerGameInput = document.getElementById('max-steps-per-game');
  renderDuringTrainingCheckbox = document.getElementById('render-during-training');

  trainButton = document.getElementById('train');
  testButton = document.getElementById('test');
  iterationStatus = document.getElementById('iteration-status');
  iterationProgress = document.getElementById('iteration-progress');
  trainStatus = document.getElementById('train-status');
  bestPosition = document.getElementById('best-position');
