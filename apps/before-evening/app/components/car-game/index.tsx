		...
		<div className="car-game-container">
			{!doNotRenderStats && (
				<table id="controls">
					<tbody>
						<tr>
							<td id="fps" colSpan={2} align="right" />
						</tr>
						<tr>
							<th>
						...
						<tr>
							<th>
								<label htmlFor="roadWidth">
									Road Width (<span id="currentRoadWidth" />) :
								</label>
							</th>
							<td>
								<input
						...
						<tr>
							<th>
								<label htmlFor="cameraHeight">
									CameraHeight (<span id="currentCameraHeight" />) :
								</label>
							</th>
							<td>
								<input
						...
						<tr>
							<th>
								<label htmlFor="drawDistance">
									Draw Distance (<span id="currentDrawDistance" />) :
								</label>
							</th>
							<td>
								<input
						...
						<tr>
							<th>
								<label htmlFor="fieldOfView">
									Field of View (<span id="currentFieldOfView" />) :
								</label>
							</th>
							<td>
								<input
						...
						<tr>
							<th>
								<label htmlFor="fogDensity">
									Fog Density (<span id="currentFogDensity" />) :
								</label>
							</th>
							<td>
								<input
					...
					<div id="hud">
						<span id="speed" className="hud">
							<span id="speed_value" className="value">
								{gameStateService.beforeEvening.stats.speed}
							</span>{" "}
							km/h
						</span>
						<span id="current_lap_time" className="hud">
							...
							<span id="current_lap_time_value" className="value">
								{gameStateService.beforeEvening.stats.currentLapTime}
							</span>
						</span>
						...
						{gameStateService.beforeEvening.stats.bestLapTime && (
							<span id="fast_lap_time" className="hud">
								Fastest Lap:{" "}
								<span id="fast_lap_time_value" className="value">
									{gameStateService.beforeEvening.stats.bestLapTime}
								</span>
							</span>
						)}
			...
			{!doNotRenderStats && (
				<Stats stats={gameStateService.beforeEvening.stats} />
			)}
		</div>
	);
};
